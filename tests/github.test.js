...
describe("validateRepo()", () => {
    ...
    it("should throw on invalid repository names", () => {
        ...
        assert.throws(() => validateRepo("user//repo"), /Invalid repository name/);
    });
...
describe("fetchRelease()", () => {
    ...
    it("should fetch specific release when tag is specified", async () => {
        server.get("/repos/user/repo/releases/v2.0.0", {
            status: 200,
    ...
    it("should throw when release is not found", async () => {
        ...
        await assert.rejects(
            ...
            /Error fetching release: 404/
        );
    });

    it("should throw when invalid tag name is provided", async () => {
        server.get("/repos/user/repo/releases/invalid", {
            status: 200,
            body: {
                html_url: "https://github.com/user/repo/releases/invalid",
                tag_name: "invalid",
